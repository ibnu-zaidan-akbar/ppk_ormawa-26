...
export default function Weather(){
    ...
    return (
        <div className="p-5 max-w-[1290px] bg-white mx-auto border-3 border-[#936440]/60">
            ...
            <div className="flex gap-4 -mx-5 px-4 border-y-3 border-[#936440]/60 py-4 overflow-hidden">
                {weatherData.daily.time.map((date, index) => {
                    ...
                    return (
                        <React.Fragment key={date}>
                            <div key={date} onClick={() => setSelectedDate(date)} className={"flex flex-col min-w-[100px] p-11 -m-4 cursor-pointer transition-all text-center items-center " + (isSelected ? "bg-[#0B592F]/15 hover:bg-[#F0E7D7]" : "bg-white hover:bg-gray-50")}>
            ...
            <div className="p-5">
                ...
                <div className="flex gap-3 overflow-x-auto costum-scrollbar pb-5">
                    ...
                    // {selectedHourlyData.filter((_, index) => index % 2 === 0).map((data, index) => {
                        ...
                        return (
                            <div key={index} className="bg-[#EAE2D5] p-5 rounded-xl shadow-lg text-center">
